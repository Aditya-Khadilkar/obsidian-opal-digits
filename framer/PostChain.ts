// Ported from src/post/composer.ts. Same render path: the material writes
// linear HDR, bloom runs on those values, then the output pass applies tone
// mapping and the sRGB encode at the very end.
//
// The postprocessing classes are subpath imports of the "three" package
// itself, so they need the same version pin as the "three" import or Framer
// can resolve two different copies of three.js into the same page.

import * as THREE from "three@0.169.0"
import { EffectComposer } from "three@0.169.0/examples/jsm/postprocessing/EffectComposer.js"
import { RenderPass } from "three@0.169.0/examples/jsm/postprocessing/RenderPass.js"
import { UnrealBloomPass } from "three@0.169.0/examples/jsm/postprocessing/UnrealBloomPass.js"
import { OutputPass } from "three@0.169.0/examples/jsm/postprocessing/OutputPass.js"
import { ShaderPass } from "three@0.169.0/examples/jsm/postprocessing/ShaderPass.js"
...
/**
 * The full render path: the material's linear HDR output, bloom, tone
 * mapping plus the sRGB encode, then grain.
 */
