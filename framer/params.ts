// Single source of truth for every tunable value, ported from src/params.ts.
// The Framer component's property controls set a handful of these; the rest
// come from DEFAULT_PARAMS and whichever preset is selected.

import type { QualitySetting } from "./quality"

/** Debug views. The numeric values must match the VIEW_* defines in shaders.ts. */
